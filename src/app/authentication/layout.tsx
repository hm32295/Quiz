...
export default function RootLayout({
  ...
  children: React.ReactNode;
    ...
    return (
     <html>
      <body>
         <div className="p-[20px] sm:p-[50px] h-[100vh] flex justify-center items-center bg-[#0D1321] ">
               <div className='w-full max-w-[1350px] flex items-center gap-[50px] justify-center'>
