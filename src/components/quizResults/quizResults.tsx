...
export default function QuizResults({
  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-4">
      <div className="animate__animated animate__fadeIn bg-white shadow-lg rounded-2xl p-6">
        {/* Header */}
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-6">
          ...
          <div className="flex justify-center md:justify-end w-full md:w-auto animate__animated animate__zoomIn">
            <div className="relative w-28 h-28 flex items-center justify-center">
              ...
              ></div>
              <span className="relative text-xl font-bold text-gray-800">
                {percent}%
              </span>
            </div>
          </div>
        ...
        <div className="space-y-6">
          {data?.questions?.map((q: Question, idx: number) => {
            ...
            return (
              <div
                key={q._id}
                className="animate__animated animate__fadeInUp border border-gray-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow duration-300"
              >
